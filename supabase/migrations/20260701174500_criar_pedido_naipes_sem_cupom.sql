-- ============================================================
-- Naipes da Pomba Gira — blindagem contra cupom
-- ------------------------------------------------------------
-- Regra de negócio: naipes-da-pombo-gira não tem desconto de nenhum tipo.
-- O rateio de cupom (R$ fixo no total) distribuía proporcionalmente entre
-- TODAS as leituras do pedido, incluindo o naipe. Aqui o cupom passa a
-- incidir só sobre as leituras ELEGÍVEIS (não-naipe): a base do cupom é
-- v_soma_elig e o rateio percorre apenas os filhos elegíveis. Front espelha
-- essa regra em _cupomDesconto (base = soma das leituras não-naipe).
-- ============================================================
