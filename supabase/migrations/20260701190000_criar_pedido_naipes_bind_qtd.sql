-- ============================================================
-- Naipes da Pomba Gira — amarra o preço à qtd de perguntas
-- ------------------------------------------------------------
-- Antes: para o naipe a RPC só checava valor_original IN (30,56,78,96),
-- sem ligar o valor à quantidade de perguntas declarada. Um cliente
-- chamando criar_pedido direto podia mandar valor 30 (tier de 1 pergunta)
-- com N perguntas — o preço não ficava amarrado ao escopo pago.
-- Agora o item traz num_perguntas (1..4) e o valor DEVE bater com o preço
-- acumulado desse tier (1→30, 2→56, 3→78, 4→96). Fonte da tabela: o array
-- NAIPE_CUSTO do front ([30,26,22,18] cumulativo).
-- Demais leituras seguem validando qty como múltiplo do preço do catálogo.
-- ============================================================
